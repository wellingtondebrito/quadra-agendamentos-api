...
public class SportCourt {
    ...
    private Owner owner; // Proprietário da quadra

    private String rules; // Regras de uso da quadra
    private String paymentMethods; // Métodos de pagamento aceitos

    @OneToMany(mappedBy = "sportsCourt", cascade = CascadeType.ALL)
    private List<Review> reviews = new ArrayList<>();
    // Relacionamento com a entidade Review
